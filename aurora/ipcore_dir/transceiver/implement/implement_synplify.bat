...
COPY transceiver_example_design.edf .\results\

ECHO Copying files from example design directory to the results directory
COPY ..\example_design\transceiver_example_design.ucf .\results\
CD results
...
ngdbuild transceiver_example_design

REM  -----------------------------------------------------------------------------
REM-------------------------------Run map-------------------------------------------

ECHO 'Running map'
map -detail transceiver_example_design -o mapped.ncd
...
ECHO INFO:Implementation is complete for transceiver_example_design
