...
//  /   /         Filename : PLL.v
// /___/   /\     Timestamp : 05/15/2018 17:10:22
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: xaw2verilog -intstyle C:/Users/yuavlasikov/git/aurora/ipcore_dir/PLL.xaw -st PLL.v
//Design Name: PLL
...
// For block PLL_ADV_INST, Estimated PLL Jitter for CLKOUT1 = 0.212 ns
...
module PLL(CLKIN1_IN, 
   ...
   PLL_ADV #( .BANDWIDTH("OPTIMIZED"), .CLKIN1_PERIOD(10.000), 
         .CLKIN2_PERIOD(10.000), .CLKOUT0_DIVIDE(12), .CLKOUT1_DIVIDE(25), 
         ...
         .CLKFBOUT_MULT(6), .CLKFBOUT_PHASE(0.0), .REF_JITTER(0.000000) ) 
